...
pub use settings_context::{
    load_global_config_yaml, resolved_project_store_dir, resolved_store_dir,
};
pub(crate) use settings_context::{
    ...
    global_virtual_store_flags, load_npm_config, make_client, open_store,
    ...
    resolve_virtual_store_dir_max_length_for_cwd, resolved_cache_dir,
